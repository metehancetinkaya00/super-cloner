...
public class enemyscript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			viewMeshFilter.GetComponent<MeshRenderer>().material = triggeredmaterial;

			//GetComponent<enemyfollow>().enabled = true;
			//GetComponent<enemyscript>().enabled = false;
			//enemys look mesh

			//  StopCoroutine(waittoreturnpath());
		}
		if (canSeePlayer == false)
		{
			viewMeshFilter.GetComponent<MeshRenderer>().material = mymaterial;
		}
